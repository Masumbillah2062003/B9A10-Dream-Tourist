...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 py-6 lg:px-20">
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">
        {/* Left Section */}
        <div className="mb-4 lg:mb-0">
          <p className="text-3xl font-bold">Dream Tourist</p>
          <p className="text-lg">© 2024 Dream Tourist. All rights reserved.</p>
        </div>
